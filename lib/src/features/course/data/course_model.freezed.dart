...
abstract class $CourseModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String title, List<SubjectModel>? subjects});
}
...
class _$CourseModelImpl implements _CourseModel {
  _$CourseModelImpl({required this.title, final List<SubjectModel>? subjects})
      : _subjects = subjects;
  ...
  @override
  String toString() {
    return 'CourseModel(title: $title, subjects: $subjects)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, title, const DeepCollectionEquality().hash(_subjects));
...
abstract class _CourseModel implements CourseModel {
  factory _CourseModel(
      ...
      final List<SubjectModel>? subjects}) = _$CourseModelImpl;
