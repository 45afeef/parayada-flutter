...
abstract class $SubjectModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, String imageUrl, List<UnitModel>? units});
}
...
class _$SubjectModelImpl implements _SubjectModel {
  ...
  @override
  String toString() {
    return 'SubjectModel(name: $name, imageUrl: $imageUrl, units: $units)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, name, imageUrl, const DeepCollectionEquality().hash(_units));
...
abstract class _SubjectModel implements SubjectModel {
  factory _SubjectModel(
      ...
      final List<UnitModel>? units}) = _$SubjectModelImpl;
