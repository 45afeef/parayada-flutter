import 'package:parayada/src/presentation/lesson/data/repositories/local_repo.dart';
import 'package:parayada/src/presentation/lesson/domain/repositories/lesson_repository.dart';
import 'package:parayada/src/presentation/mind_map/domain/mind_map.dart';
...
class LessonController extends GetxController {
  ...
  final Rx<Lesson> lesson =
      Rx<Lesson>(Lesson(title: 'title', description: 'description', topics: [
    'one',
    'two',
    'three',
    'four',
